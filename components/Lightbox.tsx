  ...
  return (
    ...
    >
      <button
        ...
        className="absolute right-6 top-6 rounded-full bg-white/20 px-4 py-2 text-sm font-semibold text-white transition hover:bg-white/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
      >
        Close
      </button>
      <div className="relative flex w-full max-w-5xl flex-col gap-4 text-white">
        <div
          className="relative aspect-[3/2] w-full overflow-hidden rounded-lg bg-black"
